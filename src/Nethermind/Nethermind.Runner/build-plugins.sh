...
NETHERMIND_PATH="D:/Workspace/Demerzel/ndm/src/nethermind/src/Nethermind/"
NDM_PATH="D:/Workspace/Demerzel/ndm/src/"
NETHERMIND_RUNNER_BIN_PATH="${NETHERMIND_PATH}Nethermind.Runner/bin/Debug/netcoreapp3.1/plugins/"
