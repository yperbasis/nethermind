                ...
                switch (_chainSpec.SealEngineType)
                {
                    ...
                    case SealEngineType.AuRa:
                    {
                        ...
                        ReadOnlyChain producerChain = GetProducerChain((db, s, b, t, l)  => 
                            new[] {validator = new AuRaAdditionalBlockProcessorFactory(_chainSpec.AuRa, s, new AbiEncoder(), t, b, _receiptStorage, _validatorStore, l).CreateValidatorProcessor(_chainSpec.AuRa.Validators)});
                        PendingTransactionSelector pendingTransactionSelector = new PendingTransactionSelector(_txPool, producerChain.ReadOnlyStateProvider, _logManager);
        ...
        private void InitSealEngine(IList<IAdditionalBlockProcessor> blockPreProcessors)
        {
            switch (_chainSpec.SealEngineType)
            {
                ...
                case SealEngineType.AuRa:
                    ...
                    var validatorProcessor = new AuRaAdditionalBlockProcessorFactory(_chainSpec.AuRa, _stateProvider, abiEncoder, _transactionProcessor, _blockTree, _receiptStorage, _validatorStore, _logManager)
