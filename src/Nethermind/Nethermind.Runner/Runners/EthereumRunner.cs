        ...
        private void InitSealEngine(IList<IAdditionalBlockProcessor> blockPreProcessors)
        {
            switch (_chainSpec.SealEngineType)
            {
                ...
                case SealEngineType.AuRa:
                    ...
                    var validatorProcessor = new AuRaAdditionalBlockProcessorFactory(_chainSpec.AuRa, _dbProvider.StateDb, _stateProvider, abiEncoder, _transactionProcessor, _blockTree, _receiptStorage, _logManager)
