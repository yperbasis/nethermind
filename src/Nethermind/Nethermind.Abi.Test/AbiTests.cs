...
namespace Nethermind.Abi.Test
{
    ...
    public class AbiTests
    {
        ...
        public void test()
        {
            AbiSignature signature = new AbiSignature("slot0");
            byte[] data = Bytes.FromHexString("");
            
            var decoded = _abiEncoder.Decode(AbiEncodingStyle.None, )
            
            var integer = new AbiUInt(16);
            integer.Decode(data, 35, false);
        }
