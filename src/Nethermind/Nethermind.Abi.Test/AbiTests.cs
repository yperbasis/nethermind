...
namespace Nethermind.Abi.Test
{
    ...
    public class AbiTests
    {
        ...
        public void test()
        {
            AbiSignature signature = new AbiSignature("slot0", AbiType.UInt160, AbiType.Int24, AbiType.UInt16, AbiType.UInt16, AbiType.UInt16, AbiType.UInt8, AbiType.Bool);
            byte[] data = Bytes.FromHexString("");

            var decoded = _abiEncoder.Decode(new AbiEncodingInfo(AbiEncodingStyle.None, signature), data);
        }
