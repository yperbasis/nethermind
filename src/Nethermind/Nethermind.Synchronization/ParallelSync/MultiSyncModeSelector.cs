                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        else if (!FastSyncEnabled)
                        {
                            ...
                            _logger.Info($"Any peers, peerBlock.Value: {peerBlock.Value} peer difficulty: {peerDifficulty.Value}, SynProgressDifficulty: {_syncProgressResolver.ChainDifficulty}");
