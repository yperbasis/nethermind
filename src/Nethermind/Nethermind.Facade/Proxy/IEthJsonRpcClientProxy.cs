...
namespace Nethermind.Facade.Proxy
{
    public interface IEthJsonRpcClientProxy
    {
        ...
        Task<RpcResult<BlockModel<Keccak>>> eth_getBlockByHash(Keccak blockHash,
        ...
        Task<RpcResult<string>> eth_getBlockRlp(BlockParameterModel blockParameter);

        Task<RpcResult<BlockModel<TransactionModel>>> eth_getBlockByNumberWithTransactionDetails(
