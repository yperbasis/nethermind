...
namespace Nethermind.AuRa.Test.Validators
{
    public class ContractValidatorTests
    {
        ...
        private IReceiptFinder _receiptsFinder;
        ...
        public void SetUp()
        {
            ...
            _receiptsFinder = Substitute.For<IReceiptFinder>();
        ...
        {
            Action act = () => new ContractValidator(null, _stateProvider, _abiEncoder, _transactionProcessor, _blockTree, _receiptsFinder, _validatorStore, _validSealerStrategy, _logManager, 1);
        ...
        {
            Action act = () => new ContractValidator(_validator, _stateProvider, _abiEncoder, _transactionProcessor, _blockTree, _receiptsFinder, null, _validSealerStrategy, _logManager, 1);
            act.Should().Throw<ArgumentNullException>();
        }
        ...
        {
            Action act = () => new ContractValidator(_validator, _stateProvider, _abiEncoder, _transactionProcessor, _blockTree, _receiptsFinder, _validatorStore, null, _logManager, 1);
            act.Should().Throw<ArgumentNullException>();
        }
        ...
        {
            Action act = () => new ContractValidator(_validator, null, _abiEncoder, _transactionProcessor, _blockTree, _receiptsFinder, _validatorStore, _validSealerStrategy, _logManager, 1);
            act.Should().Throw<ArgumentNullException>();
        }
        ...
        {
            Action act = () => new ContractValidator(_validator, _stateProvider, null, _transactionProcessor, _blockTree, _receiptsFinder, _validatorStore, _validSealerStrategy, _logManager, 1);
            act.Should().Throw<ArgumentNullException>();
        }
        ...
        {
            Action act = () => new ContractValidator(_validator, _stateProvider, _abiEncoder, null, _blockTree, _receiptsFinder, _validatorStore, _validSealerStrategy, _logManager, 1);
            act.Should().Throw<ArgumentNullException>();
        }
        ...
        {
            Action act = () => new ContractValidator(_validator, _stateProvider, _abiEncoder, _transactionProcessor, null, _receiptsFinder, _validatorStore, _validSealerStrategy, _logManager, 1);
            act.Should().Throw<ArgumentNullException>();
        }
        ...
        {
            Action act = () => new ContractValidator(_validator, _stateProvider, _abiEncoder, _transactionProcessor, _blockTree, _receiptsFinder, _validatorStore, _validSealerStrategy, null, 1);
            act.Should().Throw<ArgumentNullException>();
        }
        ...
        public void throws_ArgumentNullException_on_empty_contractAddress()
        {
            ...
            Action act = () => new ContractValidator(_validator, _stateProvider, _abiEncoder, _transactionProcessor, _blockTree, _receiptsFinder, _validatorStore, _validSealerStrategy, _logManager, 1);
        ...
        public void creates_system_account_on_start_block()
        {
            ...
            var validator = new ContractValidator(_validator, _stateProvider, _abiEncoder, _transactionProcessor, _blockTree, _receiptsFinder, _validatorStore, _validSealerStrategy, _logManager, 1);
        ...
        public void initializes_pendingValidators_from_db()
        {
            ...
            IAuRaValidatorProcessor validator = new ContractValidator(_validator, _stateProvider, _abiEncoder, _transactionProcessor, _blockTree, _receiptsFinder, _validatorStore, _validSealerStrategy, _logManager, 1);
        ...
        public void loads_initial_validators_from_contract()
        {
            ...
            IAuRaValidatorProcessor validator = new ContractValidator(_validator, _stateProvider, _abiEncoder, _transactionProcessor, _blockTree, _receiptsFinder, _validatorStore, _validSealerStrategy, _logManager, startBlockNumber);
            validator.SetFinalizationManager(_blockFinalizationManager);
        ...
        public void consecutive_initiate_change_gets_finalized_and_switch_validators(ConsecutiveInitiateChangeTestParameters test)
        {
            ...
            IAuRaValidatorProcessor validator = new ContractValidator(_validator, _stateProvider, _abiEncoder, _transactionProcessor, _blockTree, _receiptsFinder, _validatorStore, _validSealerStrategy, _logManager, test.StartBlockNumber);
            validator.SetFinalizationManager(_blockFinalizationManager);
