...
namespace Nethermind.Merge.Plugin.Synchronization
{
    public class BeaconSync : IMergeSyncController, IBeaconSyncStrategy
    {
        ...
        {
            long lowestBeaconHeaderNumber = _blockTree.LowestInsertedBeaconHeader?.Number ?? 0;
            bool finished = _blockTree.LowestInsertedBeaconHeader == null
                            || lowestBeaconHeaderNumber <= _beaconPivot.PivotDestinationNumber;
                          //  || lowestBeaconHeaderNumber <= (_blockTree.BestSuggestedHeader?.Number ?? long.MaxValue); // ToDo Sarah
