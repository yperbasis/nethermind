...
namespace Nethermind.Dsl.Contracts
{
    public class UniswapV3Pool : BlockchainBridgeContract
    {
        ...
        public (double, int, ushort, ushort, ushort, byte, bool) slot0(BlockHeader header)
        {
            return ConstantContract.Call<double, int, ushort, ushort, ushort, byte, bool>(header, nameof(slot0), Address.Zero);
        }
    }
}