...
// Generated from DslGrammar.g4 by ANTLR 4.9
...
public partial class DslGrammarParser : Parser {
	...
	public ExpressionContext expression() {
		...
		try {
			...
			case WATCH:
				EnterOuterAlt(_localctx, 1);
				{
				State = 22; watchExpression();
				}
				break;
			case WHERE:
				EnterOuterAlt(_localctx, 2);
				{
				State = 23; whereExpression();
				}
				break;
			case PUBLISH:
				EnterOuterAlt(_localctx, 3);
				{
				State = 24; publishExpression();
				}
				break;
			case AND:
				EnterOuterAlt(_localctx, 4);
				{
				State = 25; andCondition();
				}
				break;
			case OR:
				EnterOuterAlt(_localctx, 5);
				{
				State = 26; orCondition();
				}
				break;
			default:
	...
	public PublishExpressionContext publishExpression() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 35; Match(PUBLISH);
			State = 36; Match(PUBLISH_VALUE);
			State = 37;
			_la = TokenStream.LA(1);
	...
	public ConditionContext condition() {
		...
		try {
			...
			{
			State = 39; Match(WORD);
			State = 40; Match(BOOLEAN_OPERATOR);
			State = 41;
			_la = TokenStream.LA(1);
