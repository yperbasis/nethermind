...
//
//             RefundService refundService = new RefundService(_ndmBridge, _abiEncoder, _depositRepository, _contractAddress, LimboLogs.Instance, _txPool);
//
...
//             RefundService refundService = new RefundService(_ndmBridge, _abiEncoder, _depositRepository, _contractAddress, LimboLogs.Instance, _txPool, wallet);
//
//             // it will not work so far as we do everything within the same block and timestamp is wrong
//             
...
//             var refundService = new RefundService(_ndmBridge, _abiEncoder, _depositRepository, _contractAddress, LimboLogs.Instance, _txPool, wallet);
