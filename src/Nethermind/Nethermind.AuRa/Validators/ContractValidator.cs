...
namespace Nethermind.AuRa.Validators
{
    public class ContractValidator : AuRaValidatorProcessorBase
    {
        ...
        public override void PreProcess(Block block, ProcessingOptions options = ProcessingOptions.None)
        {
            ...
            var shouldLoadValidators = Validators == null || isProducingBlock || !_finalizableTransitions;
            ...
            if (shouldLoadValidators)
            {
                ...
                if (mainChainProcessing && _finalizableTransitions)
                {
        ...
        private PendingValidators LoadPendingValidators() => _finalizableTransitions ? _validatorStore.PendingValidators : null;
