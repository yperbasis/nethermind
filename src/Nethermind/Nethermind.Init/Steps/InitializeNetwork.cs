...
namespace Nethermind.Init.Steps
{
    ...
    public class InitializeNetwork : IStep
    {
        ...
        protected virtual MultiSyncModeSelector CreateMultiSyncModeSelector(SyncProgressResolver syncProgressResolver)
            => new(syncProgressResolver, _api.SyncPeerPool!, _syncConfig, No.BeaconSync, _api.SpecProvider!, _api.LogManager, _api.ChainSpec?.SealEngineType == SealEngineType.Clique);
